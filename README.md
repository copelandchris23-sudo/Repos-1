...
Names already in the 2021 catalog are kept; later datasets only add species that are not already present. Arnold habit and IUCN/BGCI conservation status fill empty fields on existing rows.

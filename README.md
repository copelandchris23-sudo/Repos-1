...
- DGH production method / fall hazard guide — genus-level thin bark, coarse roots, production method, and planting season applied to every matching genus already in the catalog
